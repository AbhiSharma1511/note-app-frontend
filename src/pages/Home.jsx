        ...
        error.message === "Request failed with status code 400" ? (
          ...
          <div className="fixed top-16 left-0 w-full h-full flex items-center justify-center">
            <div className="p-10 bg-gray-200 rounded-lg shadow-lg">
              <h2 className="text-2xl">You have to login first !!!</h2>
              <h2 className=" w-full text-center ">Click on: <button className="text-blue-400 underline" onClick={handleLogin}>Login</button></h2>
            </div>
          </div>
        )
      ) : (
